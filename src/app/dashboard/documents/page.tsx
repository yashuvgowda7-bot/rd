        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-400 mt-2">Upload PDFs and ask questions about them using RAG.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {documents.length === 0 && (
                    <div className="col-span-full py-12 text-center text-gray-500 border border-dashed border-white/10 rounded-xl flex flex-col items-center justify-center space-y-3">
                        <Files className="opacity-20" size={48} />
                        <p>No documents yet. Click the upload button to get started!</p>
                    </div>
                )}
            </div>
        </div>
